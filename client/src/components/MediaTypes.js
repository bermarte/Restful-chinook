        ...
        const Home = () => (
            <Row>
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {getMediaTypes.map((mediatype, index) => <tr key={index + 1}>
                            ...
                            <td className="align-middle">
                                <ButtonGroup>
                                    <Button
                                        ...
                                        role="button"
                                        onClick={() => this.editItem(mediatype.MediaTypeId, mediatype.Name)}>
                                        <PencilIcon/>
                                    </Button>
                                    {/* to="/playlist/add" */}
                                    <Button
                                        className="btn btn-secondary btn-sm"
                                        role="button"
                                        onClick={() => this.deleteItem(mediatype.MediaTypeId, index)}>X</Button>
                                    {/* to="/playlist/search" */}
                                </ButtonGroup>
                            </td>
                        </tr>)
            ...
            const MediaTypeListForm = () => {
                ...
                const saveMediaTypelist = async(list) => {
                    ...
                    try {
                        ...
                        newState
                            .getMediaTypes
                            .push({MediaTypeId: newId, Name: list});
                                ...
                                <Jumbotron>
                                    <Form onSubmit={handleSubmit}>
                                        <Form.Group>
                                            ...
                                            <Form.Control
                                                onChange={handleMediaTypelistChange}
                                                type="text"
                                                placeholder="Media-type name"
                                                required/>
                                        </Form.Group>
                        ...
                        <h3>
                            ...
                            <ButtonGroup className="ml-2">
                                ...
                                <Link
                                    className="btn btn-secondary btn-sm"
                                    role="button"
                                    to="/media-type/search">search</Link>
