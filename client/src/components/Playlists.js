        ...
        const Home = () => (
            <Row>
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {getPlaylists.map((playlist, index) => <tr key={index + 1}>
                            ...
                            <td className="align-middle">
                                <ButtonGroup>
                                    <Button
                                        ...
                                        role="button"
                                        onClick={() => this.editItem(playlist.PlaylistId, playlist.Name)}>
                                        <PencilIcon/>
                                    </Button>
                                    {/* to="/playlist/add" */}
                                    <Button
                                        className="btn btn-secondary btn-sm"
                                        role="button"
                                        onClick={() => this.deleteItem(playlist.PlaylistId, index)}>X</Button>
                                    {/* to="/playlist/search" */}
                                </ButtonGroup>
                            </td>
                        </tr>)
            ...
            const PlayListForm = () => {
                ...
                const savePlaylist = async(list) => {
                    ...
                    try {
                        ...
                        newState
                            .getPlaylists
                            .push({PlaylistId: newId, Name: list});
