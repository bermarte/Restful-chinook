            ...
            <Row>
                <Table striped bordered hover>
                    ...
                    <tbody>
                        ...
                        {getTracks.map((track, index) => <tr key={index + 1}>
                            ...
                            <td className="align-middle">
                                <ButtonGroup>
                                    <Link
                                        ...
                                        role="button"
                                        to={`/track/edit/${track.TrackId}`}>
                                        <PencilIcon/>
                                    </Link>
                                    <Button
                                        className="btn btn-primary btn-sm"
                                        role="button"
                                        onClick={() => this.deleteItem(track.TrackId, index)}>X</Button>
                                </ButtonGroup>
                            </td>
                        </tr>)}
                    </tbody>
        ...
        const AddTrack = () => {
            ...
            const TrackListForm = () => {
                ...
                const handleSubmit = (event) => {
                    ...
                    saveTracklist(trackName, albumid, mediaid, genreid, composer, time, bytes, price);
                };
                ...
                const saveTracklist = async(trackName, albumid, mediaid, genreid, composer, time, bytes, price) => {
                    const settings = {
                        method: 'POST',
                        headers: {
                            Accept: 'application/json',
                    ...
                    try {
                        ...
                        const newState = Object.assign({}, this.state);
                        const newId = newState.getTracks.length + 1;
                        newState
                            .getTracks
                            .push({
                                TrackId: newId,
            ...
            const TrackListForm = () => {
                ...
                useEffect(() => {
                    const timer = setTimeout(() => {
                        ...
                        document
                            .getElementById('trackid')
                            .innerHTML = `# ${filldata[0]}`;
                        document
                            .getElementById('trackname')
                            .value = filldata[1];
                        document
                            .getElementById('albumid')
                            .value = filldata[2];
                        document
                            .getElementById('mediaid')
                            .value = filldata[3];
                        document
                            .getElementById('genreid')
                            .value = filldata[4];
                        document
                        ...
                        document
                            ...
                            .value = filldata[6];
                        document
                            .getElementById('manybytes')
                            .value = filldata[7];
                        document
                            .getElementById('theprice')
                            .value = filldata[8];
